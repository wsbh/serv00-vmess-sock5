...
menu() {
   ...
   echo -e "${green}由 秋名山 qmsdh.com 三改，yutian81二改：${re}${yellow}https://github.com/yutian81/serv00-ct8-ssh${re}\n"
   echo -e "${green}秋名山温馨提示：记得GitHub Action保活！\n"
   echo -e "${green}GitHub地址：https://github.com/qmsdh/serv00-vmess-sock5 \n"
   purple "转载请著名出处，请勿滥用\n"
   red "1. 安装sing-box"
   echo  "----------------"
   red "2. 卸载或清理服务器"
